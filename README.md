...
ストア公開までの期間は、iosではPC経由でデプロイすることで、androidではapkファイルを起動することによって全機能を利用することが出来ます。
...
### 背景(製品開発のきっかけ、課題等）
薬局の現場で感じる睡眠薬の処方頻度の多さに対して課題観を感じており、そこに趣味の筋トレを組み合わせました。

若いうちの健康はもちろん、年老いてからも体に不自由のない丈夫な体を手に入れるための一助になればとの願いを込めて開発しています。
...
・就寝1時間前からスマホを触れない機能で光の刺激から離れましょう．就寝前モードで準備しておくことにより、ボタン一つで就寝モードに切り替えることが出来ます.

・規則的な就寝時刻と起床時刻で、安定した生活リズムを実現しましょう.
