...
<<<<<<< Updated upstream:dptr/lib/view/squat_widget.dart
...
import 'morning_training_model.dart';
export 'morning_training_model.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:health_sleep/model_view/moring_training_recorder_model_view.dart';

class MorningTrainingWidget extends ConsumerWidget {
  const MorningTrainingWidget({Key? key}) : super(key: key);
...
/*
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final recorderController = ref.read(morningRecorderProvider.notifier);
    final recorder = ref.watch(morningRecorderProvider);
    var _model = createModel(context, () => MorningTrainingModel());
...
/*
class MorningTrainingWidget extends StatefulWidget {
  const MorningTrainingWidget({Key? key}) : super(key: key);
>>>>>>> Stashed changes:health_sleep/lib/subpage/morning_training/morning_training_widget.dart
